  ...
  void _showConfirmDialog(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('${action == 'approved' ? 'Approve' : 'Reject'} Doctor'),
        content: Text(
            'Are you sure you want to ${action == 'approved' ? 'approve' : 'reject'} Dr. $name?'),
        actions: [
          TextButton(
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('No Pending Doctor Requests',
                      style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.w600,
                          color: Color(0xFF3D3D3A))),
                  const SizedBox(height: 6),
                  const Text('All doctor registrations are reviewed',
...
class _PendingDoctorCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final experience = data['yearsOfExperience']?.toString() ?? '0';
            ...
            child: Column(
              ...
              children: [
                ...
                _InfoRow(Icons.local_hospital_outlined,
                    hospital.isNotEmpty ? hospital : 'No hospital provided'),
        ...
        children: [
          ...
          if (url.isNotEmpty)
            const Icon(Icons.open_in_new_rounded,
                size: 15, color: Color(0xFF888780)),
        ],
      ),
    );
  }
